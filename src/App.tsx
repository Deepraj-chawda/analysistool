...
import AIDetection from "./pages/AssessmentWorkbench";
import FaceRecognition from "./pages/AssessmentResults";
import NotFound from "./pages/NotFound";
import Navigation from "./components/Navigation";
import { useAutoLogout } from '@/hooks/useAutoLogout';
import { AutoLogoutHandler } from "./components/AutoLogoutHandler";
import PixelStatistics from "./pages/GapAssessmentSetup";

import GapAssessmentSetup from "./pages/GapAssessmentSetup";
import AssessmentWorkbench from "./pages/AssessmentWorkbench";
import AssessmentResults from "./pages/AssessmentResults";
import AssessmentWorkbench1 from "./pages/AssessmentWorkbench1";
                  ...
                  <>
                    ...
                    <div className="flex-grow">
                      <Routes>
                        ...
                        <Route path="/new" element={<AssessmentWorkbench1 />} />
